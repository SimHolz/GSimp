...
source('R/Impute_wrapper.R')

#' Generate and Impute MNAR Data
#' 
#' @description Generates Missing Not At Random (MNAR) data and performs multiple imputations
#' @param data_c Complete data matrix
#' @param mis_var_prop Vector of missing variable proportions
#' @param var_mis_prop Vector of value-based missingness proportions
#' @param impute_list Vector of imputation method names
#' @param cores Number of cores for parallel processing
#' @return List containing imputation results, complete data, and method names
...
#' Calculate and Plot NRMSE Rankings
#' 
#' @description Calculates and visualizes NRMSE rankings for different imputation methods
#' @param impute_results Results from MNAR_gen_imp
#' @param plot Logical, whether to create plot
#' @param x Variable for x-axis ('Miss_Prop' or 'Miss_Num')
#' @param colors Optional color vector for plotting
#' @param shapes Optional shape vector for plotting
#' @return List containing NRMSE rankings and melted data frame for plotting
...
#' Calculate and Plot Procrustes Analysis
#' 
#' @description Performs Procrustes analysis on dimensionality reduction results
#' @param impute_results Results from MNAR_gen_imp
#' @param DR Dimensionality reduction method ('PCA' or 'PLS')
#' @param lg Logical, whether to log transform data
#' @param nPCs Number of principal components
#' @param outcome Outcome variable for PLS
#' @param x Variable for x-axis
#' @param plot Logical, whether to create plot
#' @param colors Optional color vector for plotting
#' @param shapes Optional shape vector for plotting
#' @return List containing Procrustes sum of squares and melted data frame for plotting
...
#' Calculate and Plot T-test Correlations
#' 
#' @description Calculates correlations between t-test p-values from complete and imputed data
#' @param impute_results Results from MNAR_gen_imp
#' @param group Group labels for t-test
#' @param plot Logical, whether to create plot
#' @param x Variable for x-axis
#' @param cor Correlation type ('P' for Pearson, 'S' for Spearman)
#' @param colors Optional color vector for plotting
#' @param shapes Optional shape vector for plotting
#' @return List containing correlation results and melted data frames
...
#' Calculate and Plot T-test P-value Agreement
#' 
#' @description Calculates agreement in significant features between complete and imputed data
#' @param impute_results Results from MNAR_gen_imp
#' @param group Group labels for t-test
#' @param plot Logical, whether to create plot
#' @param p_cut P-value cutoff for significance
#' @param x Variable for x-axis
#' @param colors Optional color vector for plotting
#' @param shapes Optional shape vector for plotting
#' @return List containing p-value agreement results and melted data frame
...
#' Calculate Procrustes Analysis for Multiple Imputed Datasets
#' 
#' @description Performs pairwise Procrustes analysis on PCA results from multiple imputed datasets
#' @param imp_list List of imputed datasets
#' @param nPCs Number of principal components
#' @param method_names Vector of method names
#' @return List containing Procrustes sum of squares matrix and detailed results
...
#' Calculate NRMSE Between Multiple Imputed Datasets
#' 
#' @description Calculates pairwise NRMSE between multiple imputed datasets
#' @param imp_list List of imputed datasets
#' @param miss_df Original dataset with missing values
#' @param method_names Vector of method names
#' @return Matrix of pairwise NRMSE values
